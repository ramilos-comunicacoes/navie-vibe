...
from sistema.models import Pousada as Hotel
...
class Compra(models.Model):
    ...
    criado_por = models.ForeignKey(settings.AUTH_USER_MODEL, on_delete=models.SET_NULL, null=True, blank=True, db_constraint=False, related_name='compras_registradas')
    criado_em = models.DateTimeField(auto_now_add=True)
...
class MovimentoEstoque(models.Model):
    ...
    criado_por = models.ForeignKey(settings.AUTH_USER_MODEL, on_delete=models.SET_NULL, null=True, blank=True, db_constraint=False, related_name='movimentos_estoque')
...
class ProdutoConsumo(models.Model):
    """Produto de consumo para frigobar/serviço de quarto."""
    hotel = models.ForeignKey(Hotel, on_delete=models.CASCADE, related_name='produtos_consumo')
    estoque_produto = models.ForeignKey(Produto, on_delete=models.SET_NULL, null=True, blank=True, related_name='itens_consumo')
    nome = models.CharField(max_length=150)
    descricao = models.TextField(blank=True, null=True)
    preco = models.DecimalField(max_digits=10, decimal_places=2)
    tipo = models.CharField(max_length=20, default='bebida')
