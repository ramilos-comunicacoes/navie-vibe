...
def restaurante_detalhe(request, slug):
    ...
    galeria_data = {
        'manaca-da-serra': [
            {"titulo": "Filé Mignon com Fritas", "url": "/media/restaurantes/manaca-da-serra/carrossel/file_mignon.jpg"},
            {"titulo": "Camarão ao Fettuccine", "url": "/media/restaurantes/manaca-da-serra/carrossel/camarao_fettuccine.jpg"},
            {"titulo": "Risoto Carne de Sol", "url": "/media/restaurantes/manaca-da-serra/carrossel/risoto_carne_sol.jpg"},
            {"titulo": "Maminha Laminada", "url": "/media/restaurantes/manaca-da-serra/carrossel/maminha_laminada.jpg"},
            {"titulo": "Croquete Vaca Atolada", "url": "/media/restaurantes/manaca-da-serra/carrossel/croquete_vaca_atolada.jpg"},
            {"titulo": "Croquete de Linguiça Toscana", "url": "/media/restaurantes/manaca-da-serra/carrossel/croquete_toscana.jpg"},
            {"titulo": "Salada Agridoce", "url": "/media/restaurantes/manaca-da-serra/carrossel/salada_agridoce.jpg"},
            {"titulo": "Banana Flambada", "url": "/media/restaurantes/manaca-da-serra/carrossel/banana_flambada.jpg"},
            {"titulo": "Compota Caseira", "url": "/media/restaurantes/manaca-da-serra/carrossel/compota.jpg"},
            {"titulo": "Soda de Verão", "url": "/media/restaurantes/manaca-da-serra/carrossel/soda_verao.jpg"},
        ],
        'casa-de-engenho': [
